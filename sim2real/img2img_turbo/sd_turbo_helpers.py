...
# Original path in upstream: src/model.py
#
# Minimal edits: `make_1step_sched` accepts a torch.device (or string) so schedulers
# are not hard-tied to CUDA-only environments.
